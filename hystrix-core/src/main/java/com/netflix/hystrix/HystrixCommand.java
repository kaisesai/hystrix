...
public abstract class HystrixCommand<R> extends AbstractCommand<R>
  ...
  protected HystrixCommand(HystrixCommandGroupKey group,
    ...
    super(group, null, null, null, null, HystrixCommandProperties.Setter()
  ...
  protected HystrixCommand(HystrixCommandGroupKey group, HystrixThreadPoolKey threadPool,
                           int executionIsolationThreadTimeoutInMilliseconds) {
    super(group, null, threadPool, null, null, HystrixCommandProperties.Setter()
                                                                       .withExecutionTimeoutInMilliseconds(
                                                                         executionIsolationThreadTimeoutInMilliseconds),
          null, null, null, null, null, null);
  }
  ...
  protected HystrixCommand(Setter setter) {
    ...
    this(setter.groupKey, setter.commandKey, setter.threadPoolKey, null, null,
         setter.commandPropertiesDefaults, setter.threadPoolPropertiesDefaults, null, null, null,
         null, null);
  }
   ...
   */
  /* package for testing */HystrixCommand(HystrixCommandGroupKey group, HystrixCommandKey key,
  ...
  public Future<R> queue() {
    ...
    final Future<R> f = new Future<R>() {
      ...
      public boolean cancel(boolean mayInterruptIfRunning) {
        ...
        if (HystrixCommand.this.getProperties().executionIsolationThreadInterruptOnFutureCancel()
                               .get()) {
          /*
