...
public interface HystrixThreadPool {
  ...
  /* package */static class Factory {
     ...
     */
    /* package */final static ConcurrentHashMap<String, HystrixThreadPool> threadPools
  ...
  class HystrixThreadPoolDefault implements HystrixThreadPool {
    ...
    public HystrixThreadPoolDefault(HystrixThreadPoolKey threadPoolKey,
      ...
      this.properties = HystrixPropertiesFactory
        .getThreadPoolProperties(threadPoolKey, propertiesDefaults);
      ...
      HystrixMetricsPublisherFactory
        .createOrRetrievePublisherForThreadPool(threadPoolKey, this.metrics, this.properties);
    }
    ...
    private void touchConfig() {
      ...
      if (threadPool.getCorePoolSize() != dynamicCoreSize || (allowSizesToDiverge
        && threadPool.getMaximumPoolSize() != dynamicMaximumSize)) {
        if (maxTooLow) {
          logger.error("Hystrix ThreadPool configuration for : " + metrics.getThreadPoolKey().name()
